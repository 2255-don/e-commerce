...
<div class="row">
<x-feature-section feature="marketplace.view-cart" showDeniedMessage="true">
    <div class="col-lg-8">
        @if(empty($cart))
            <div class="card">
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <x-feature-link 
                                            feature="marketplace.remove-from-cart" 
                                            route="{{ route('checkout.remove', $item['id']) }}" 
                                            class="btn btn-icon btn-text-danger rounded-pill">
            ...
            <div class="card-body">
                ...
                @if(!empty($cart))
                    <form action="{{ route('checkout.process') }}" method="POST">
                        ...
                        <x-feature-button 
                            feature="marketplace.place-order" 
                            type="submit" 
                            class="btn btn-primary w-100 btn-lg shadow-sm mb-3">
                            Valider la commande
                        </x-feature-button>
                    </form>
                @endif
