    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item dropdown-language dropdown me-2 me-xl-0">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <i
                    class='fi fi-{{ (session()->get('locale') ?? app()->getLocale()) == 'fr' ? 'fr' : 'us' }} fis rounded-circle me-1 fs-3'></i>
            </a>
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <small class="text-muted">{{ Auth::user()?->profil?->libelle ?? 'Invité' }}</small>
                            </div>
                        </div>
                    </a>
                </li>
                ...
                <li>
                <li>
                    <a class="dropdown-item {{ Route::currentRouteName() === 'profile.show' ? 'active' : '' }}"
