            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="alert alert-warning mb-4" role="alert">
                        ...
                        <span>Pour pouvoir vendre sur notre plateforme, nous devons vérifier votre identité conformément aux
                            réglementations en vigueur.</span>
                    </div>
                    ...
                    @if ($user->kyc_status === 'pending')
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Votre document a été soumis et est en attente de validation par un
                                administrateur.</p>
                    ...
                    @elseif($user->kyc_status === 'verified')
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Votre compte est entièrement validé. Vous pouvez continuer vos activités.
                            </p>
                            <a href="{{ route('profile.show') }}" class="btn btn-primary mt-3">Retour au profil</a>
                        </div>
                    @else
                        <form id="kycForm" method="POST" action="{{ route('kyc.store') }}" enctype="multipart/form-data">
                            ...
                            <x-feature-section feature="user.kyc.submit-form">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="shop_name" name="shop_name"
                                        ...
                                        value="{{ old('shop_name', $user->sellerProfile->shop_name) }}" required>
                                </div>

                                <div class="mb-4">
                                    <label for="kyc_document" class="form-label">Pièce d'identité (CNI, Passeport,
                                        Permis)</label>
                                    <input class="form-control" type="file" id="kyc_document" name="kyc_document"
                                        accept="image/*" required>
                                    <div class="form-text mt-2 text-info">
                                        <i class="ti ti-info-circle ti-xs"></i> Formats autorisés : JPG, PNG. Taille max :
                                        2Mo.
                                    </div>
                                </div>
                            </x-feature-section>
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('profile.show') }}" class="text-muted small">Annuler et retourner au
                                    profil</a>
                            </div>
                        </form>
                    @endif
