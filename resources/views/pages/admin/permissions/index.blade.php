                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <x-feature-link feature="admin.permissions.view" route="{{ route('admin.permissions.show', $permission->id) }}" class="dropdown-item">
                                            <i class="bx bx-show me-1"></i> {{ __('View Details') }}
                                        </x-feature-link>
                                        <x-feature-link feature="admin.permissions.edit" route="{{ route('admin.permissions.edit', $permission->id) }}" class="dropdown-item">
                                            <i class="bx bx-edit me-1"></i> {{ __('Edit') }}
                                        </x-feature-link>
                                        <form action="{{ route('admin.permissions.destroy', $permission->id) }}" method="POST" class="d-inline delete-form">
                                            @csrf
                                            @method('DELETE')
                                            <x-feature-button feature="admin.permissions.delete" type="button" class="dropdown-item text-danger delete-btn">
