                    ...
                    <table class="table table-hover border-top">
                        ...
                        <tbody>
                            @forelse ($modules as $module)
                                <tr>
                                    <td>
                                        <i class='bx {{ $module->icon ?? 'bx-cube' }} bx-sm'
                                            style="color: {{ $module->color ?? '#B8860B' }}"></i>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <x-feature-link feature="admin.modules.edit"
                                                ...
                                                @if (!$module->is_core)
                                                    <form action="{{ route('admin.modules.destroy', $module->id) }}"
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <x-feature-button feature="admin.modules.delete" type="button"
