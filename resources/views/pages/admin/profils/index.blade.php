                ...
                <table class="table table-hover border-top">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-label-info">{{ $profil->users_count }} {{ __('user(s)') }}</span>
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <x-feature-link feature="profils.edit" route="{{ route('admin.profils.edit', $profil->id) }}" class="dropdown-item">
                                            <i class="ti ti-pencil me-1"></i> {{ __('Edit') }}
                                        </x-feature-link>
                                        <x-feature-link feature="admin.profils.manage-permissions" route="{{ route('admin.roles.permissions', $profil->id) }}" class="dropdown-item">
                                            <i class="bx bx-shield me-1"></i> {{ __('Manage Permissions') }}
                                        </x-feature-link>
                                        <form action="{{ route('admin.profils.destroy', $profil->id) }}" method="POST" class="d-inline delete-form">
                                            @csrf
                                            @method('DELETE')
                                            <x-feature-button feature="profils.delete" type="button" class="dropdown-item text-danger delete-btn">
