...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">{{ __('Administration') }} / {{ __('Profile Management') }} /</span> {{ __('Edit') }}
</h4>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">{{ __('Modify the profile') }}: <span class="text-primary">{{ $profil->libelle }}</span></h5>
            </div>
            <div class="card-body">
                @if ($errors->any())
                    ...
                    <x-feature-section feature="admin.profils.form-fields">
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">
                                {{ __('Number of users with this profile') }}: <strong>{{ $profil->users()->count() }}</strong>
                            </small>
                        </div>
                    </x-feature-section>
