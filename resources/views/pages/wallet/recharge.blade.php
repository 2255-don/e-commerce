            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h4 class="mb-1">Solde Actuel: <span
                                class="text-warning">{{ number_format($wallet->balance, 0, ',', ' ') }} FCFA</span></h4>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-6 col-md-3">
                                        <input type="radio" class="btn-check" name="provider" id="airtel"
                                            value="airtel" checked>
                                    ...
                                    <div class="col-6 col-md-3">
                                        <input type="radio" class="btn-check" name="provider" id="vodacom"
                                            value="vodacom">
                                    ...
                                    <div class="col-6 col-md-3">
                                        <input type="radio" class="btn-check" name="provider" id="orange"
                                            value=" orange">
                                    ...
                                    <div class="col-6 col-md-3">
                                        <input type="radio" class="btn-check" name="provider" id="africell"
                                            value="africell">
                    ...
                    <div class="mt-4">
                        <div class="alert alert-info">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="mb-0">
                                        <li><code>+243 97 000 0000</code> - ✅ <span class="badge bg-success">Succès</span>
                                            (Airtel)</li>
                                        <li><code>+243 81 000 0001</code> - ❌ <span class="badge bg-danger">Solde
                                                insuffisant</span> (M-Pesa)</li>
                                        <li><code>+243 84 000 0002</code> - ⚠️ <span class="badge bg-warning">Erreur
                                                réseau</span> (Orange)</li>
                                        <li><code>+243 90 000 0003</code> - 🔐 <span class="badge bg-secondary">OTP
                                                incorrect</span> (Africell)</li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <ul class="mb-0">
                                        <li><code>+243 97 000 0004</code> - 📊 <span class="badge bg-dark">Limite
                                                quotidienne</span> (Airtel)</li>
                                        <li><code>+243 81 000 0005</code> - 🔒 <span class="badge bg-dark">Compte
                                                bloqué</span> (M-Pesa)</li>
                                        <li><code>+243 84 000 0666</code> - 🐌 <span class="badge bg-info">Réseau lent
                                                (5s)</span> (Orange)</li>
                                    </ul>
                                </div>
                            </div>
